...
Run 	exttt{mp-mnv4-003} dùng raw image canonical, MediaPipe Hand Landmarker một tay, ROI vuông padding 0,10 và raw-image fallback khi detection/ROI thất bại. Nó đạt 96,38\% Accuracy và 95,64\% Macro-F1 trên P9, cao hơn 	exttt{mnv4-002} 1,87 điểm Accuracy. Đây là phát hiện/định vị và trích xuất ROI, không gọi là phân đoạn theo từng điểm ảnh vì không có segmentation mask.
