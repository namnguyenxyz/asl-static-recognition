...
\begin{itemize}
    ...
    \item xây dựng và đánh giá pipeline MediaPipe-guided ROI kết hợp MobileNetV4; nguyên mẫu desktop qua webcam chỉ được báo cáo định lượng khi có artifact độ trễ/FPS.
\end{itemize}
...
Các đóng góp có thể kiểm chứng của đồ án là: protocol participant-disjoint có loại trùng lặp SHA-256; các baseline tái lập; pipeline raw image--MediaPipe ROI--MobileNetV4 full fine-tuning; và phân tích O/0. Run 	exttt{mp-mnv4-003} có artifact bất biến, đạt Accuracy 96,66\% và Macro-F1 95,75\% trên P9. Nguyên mẫu desktop chưa là đóng góp hoàn tất vì chưa benchmark.
