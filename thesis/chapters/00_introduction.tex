...
Các đóng góp có thể kiểm chứng của đồ án là: protocol participant-disjoint có loại trùng lặp chính xác theo SHA-256; bốn baseline có artifact tái lập được; so sánh CNN, landmark+SVM và MobileNetV4 ở chế độ đóng băng/tinh chỉnh toàn bộ; và phân tích riêng hai lớp O/0. Đóng góp thực nghiệm được giới hạn ở các artifact này. ROI MediaPipe kết hợp MobileNetV4 và nguyên mẫu desktop chưa được xem là đóng góp hoàn tất vì chưa có benchmark và artifact tích hợp tương ứng.
