...
Hiệu quả của mô hình phụ thuộc vào chất lượng dữ liệu, vị trí bàn tay, điều kiện ánh sáng và mức độ tương đồng về hình dạng giữa các lớp. Đề tài sử dụng MediaPipe Hand Landmarker để phát hiện và định vị bàn tay, sau đó trích xuất vùng quan tâm (region of interest -- ROI) bằng khung bao dựa trên các điểm mốc. Phương pháp này không tạo mặt nạ phân đoạn theo từng điểm ảnh. Sự nhầm lẫn giữa hai lớp ảnh mang nhãn O và 0 được xem là một trường hợp cần phân tích riêng bằng dữ liệu đánh giá, không được giả định là lỗi phổ biến của mọi hệ thống trước đó.

\section*{2. Mục tiêu nghiên cứu}
\addcontentsline{toc}{section}{2. Mục tiêu nghiên cứu}
Mục tiêu tổng quát của đồ án là xây dựng và đánh giá pipeline phân loại 36 lớp ảnh bàn tay theo cách biểu diễn của tập ASL-HG; pipeline có thể nhận ảnh tĩnh hoặc từng khung hình webcam độc lập. Các mục tiêu cụ thể gồm:
\begin{itemize}
    ...
    \item xác định hướng mở rộng MediaPipe-guided crop kết hợp MobileNetV4 và nguyên mẫu desktop qua webcam; các hạng mục này chỉ được báo cáo định lượng khi có artifact độ trễ/FPS tương ứng.
\end{itemize}
...
Đề tài xét ảnh tĩnh một bàn tay hoặc từng khung hình webcam độc lập. Webcam cung cấp chuỗi khung hình, nhưng mô hình hiện tại không mô hình hóa thông tin thời gian giữa các khung hình; vì vậy, nhận dạng cử chỉ động, chuỗi ký hiệu, câu và diễn giải ngữ nghĩa nằm ngoài phạm vi nghiên cứu.
...
\section*{5. Đóng góp dự kiến}
\addcontentsline{toc}{section}{5. Đóng góp dự kiến}
Đóng góp dự kiến của đồ án được giới hạn ở các nội dung có thể kiểm chứng: protocol participant-disjoint có loại trùng lặp, các baseline tái lập được, quy trình đánh giá có phân tích riêng hai lớp O/0, và hướng MediaPipe-guided crop kết hợp MobileNetV4. Nguyên mẫu desktop suy luận theo webcam chỉ được xem là đóng góp khi có artifact triển khai và benchmark tương ứng.\todo{Chỉ giữ lại các đóng góp đã được chứng minh bằng kết quả và artifact sau khi hoàn tất thực nghiệm.}

\section*{6. Bố cục đồ án}
\addcontentsline{toc}{section}{6. Bố cục đồ án}
Chương 1 trình bày tổng quan bài toán và các nghiên cứu liên quan. Chương 2 giới thiệu cơ sở lý thuyết, dữ liệu và các chỉ số đánh giá. Chương 3 mô tả pipeline, mô hình và thiết kế thực nghiệm. Chương 4 trình bày kết quả và bàn luận. Chương 5 mô tả nguyên mẫu triển khai thời gian thực. Chương 6 tổng kết, nêu hạn chế và hướng phát triển.
