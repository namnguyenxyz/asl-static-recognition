...
Cấu hình, crop manifest, split, checkpoint, metrics và environment của run được chọn nằm trong artifact bất biến \texttt{mp-mnv4-003-p010}, commit \texttt{e2faeb2768d2b081a9f7c9acc410401f7b758f1b}. Cấu hình phần cứng chưa được tổng hợp để kết luận về tốc độ.
